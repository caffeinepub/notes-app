...
import type { ExternalBlob as _ExternalBlob, Note as _Note, NoteData as _NoteData, NoteId as _NoteId, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createNote(arg0: NoteData): Promise<Note> {
        if (this.processError) {
            try {
                const result = await this.actor.createNote(await to_candid_NoteData_n10(this._uploadFile, this._downloadFile, arg0));
    ...
    async updateNote(arg0: NoteId, arg1: NoteData): Promise<Note> {
        if (this.processError) {
            try {
                const result = await this.actor.updateNote(arg0, await to_candid_NoteData_n10(this._uploadFile, this._downloadFile, arg1));
                return from_candid_Note_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function to_candid_NoteData_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: NoteData): Promise<_NoteData> {
...
async function to_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        title: value.title,
        content: value.content,
        imageRefs: await to_candid_vec_n12(_uploadFile, _downloadFile, value.imageRefs),
        encrypted: value.encrypted
    };
}
